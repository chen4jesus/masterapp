  ...
  return (
    ...
    >
      ...
      <p style={{ 
        ...
        {site.description || t('book.noDescription')}
      </p>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <span style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '12px', color: '#64748b' }}>
            <Activity size={14} style={{ color: '#10b981' }} /> 99.9% {t('websites.uptime')}
          </span>
          <span style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '12px', color: '#64748b' }}>
            <BookOpen size={14} style={{ color: '#818cf8' }} /> {t('websites.books')}
          </span>
        </div>
        <span style={{ 
          display: 'flex', 
          ...
          {t('websites.manage')} <ArrowRight size={14} />
        </span>
      </div>
    </div>
  );
...
const Websites = () => {
  ...
  const fetchSites = async () => {
    ...
    setSites(data.filter(site => site.type !== 'service'));
    setLoading(false);
  };
  ...
  return (
    <div style={{ padding: '32px 40px', maxWidth: '1400px', margin: '0 auto' }}>
      ...
      <header style={{ 
        ...
        >
          <Plus size={18} /> {t('websites.addNew')}
        </button>
      </header>
      ...
      <div style={{
        ...
        {sites.length === 0 && !loading && (
          <div style={{
            ...
            <h3 style={{ color: '#94a3b8', marginBottom: '8px' }}>{t('websites.noSites')}</h3>
            <p>{t('websites.startPrompt')}</p>
          </div>
        )}
      </div>
    </div>
