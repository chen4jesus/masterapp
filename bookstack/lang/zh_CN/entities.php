...
return [
    ...
    'audios' => '媒体',
    'audios_explain' => '上传媒体文件，或指定外部媒体链接，开启页面的媒体功能',
    'audios_explain_instant_save' => '所有改动会立即生效',
    'audios_upload' => '上传文件',
    'audios_file_uploaded' => '文件上传成功',
    'audios_link' => '外部链接',
    'audios_upload_drop' => '也可以将文件拖拽到这里',
    'audios_set_link' => '设定链接',
    'audios_delete' => '确定要删除这个媒体文件吗?',
    'audios_dropzone' => '把要上传的文件拖动到这里',
    'audios_no_files' => '暂时没有上传任何文件',
    'audios_explain_link' => '如果您不想上传文件，可以使用链接。这可以是指向其他页面的链接，也可以是指向网络文件的链接。',
    'audios_link_name' => '媒体标题',
    'audio_link' => '媒体链接',
    'audios_link_url' => '媒体链接',
    'audios_link_url_hint' => '网站URL，或文件地址',
    'audio' => '媒体',
    'audios_insert_link' => '将媒体链接插入正文光标所在处',
    'audios_edit_file' => '编辑媒体',
    'audios_edit_file_name' => '媒体文件名',
    'audios_edit_drop_upload' => '可以拖拽文件到这里覆盖当前媒体',
    'audios_order_updated' => '媒体顺序更改成功',
    'audios_updated_success' => '保存成功',
    'audios_deleted' => '删除成功',
    'audios_file_updated' => '媒体文件更新成功',
    'audios_link_attached' => '媒体链接已插入正文内容',
    ...
    //Book Clubs
    'book_clubs' => "读书会",
    'book_club_new_action' => "新建读书会",
    'book_clubs_empty' => "当前未创建读书会",
    'bookclubs_popular' => '热门读书会',
    'bookclubs_popular_empty' => '最受欢迎的读书会将出现在这里。',
    'bookclubs_new' => '最新创建的读书会',
    'bookclubs_new_empty' => '最近创建的图书将出现在这里。',
    'book_club_create' => "创建读书会",
    'bookclubs_books' => '书籍已在此读书会里',
    'bookclubs_drag_books' => '拖动下面的图书将其添加到此读书会',
    'bookclubs_add_books' => '将书籍加入此读书会',
    'bookclubs_add_users' => '将用户加入此读书会',
    'bookclub_tags' => '读书会标签',
    'bookclubs_save' => '保存读书会',
    'bookclub_type' => "允许其他用户加入此读书会？",
    'bookclubs_users' => '用户已在此读书会里',
    'bookclubs_drag_users' => '拖动下面的用户将其添加到此读书会',
    'book_club_join' => '加入',
    'book_club_close_join' => '不开放',
    ...
    'club_delete' => '删除读书会',
    'club_delete_explain' => '此操作将删除读书会 ”:name”。 读书会引用的图书不会被删除。',
    'club_delete_confirmation' => '您确定要删除此读书会吗？',
    'club_empty_contents' => '此读书会目前没有选定的书籍',
    'club_edit_add_book_user' => '编辑读书会',
        'club_join_named' => 'Join Club:name',
    'club_join' => '加入读书会',
    'club_leave' => '退出读书会',
    'club_join_explain' => "加入读书会 ':name' 以后，可以看到里面的书籍。",
    'club_leave_explain' => "退出读书会 ':name' 以后，里面的书籍将无法看到。",
    'club_join_confirmation' => '您确定要加入这个读书会吗？',
    'club_leave_confirmation' => '您确定要离开这个读书会吗？',
        'members' => 'Members',
    'return_back' => "返回",
    'leave_club' => "退出",
    ...
    'write_review' => '留下您对本书的点评...',
    'save_review_msg' => '点评已提交成功!',
    'approve_review_msg' => '点评已被批准!',
    'disapprove_review_msg' => '点评已被否决!',
    'delete_review_msg' => '点评已被删除!',
    'update_review_msg' => '点评已保存成功!',
